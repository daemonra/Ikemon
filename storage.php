...
class Storage implements IStorage {
  ...
  public function addCard($record): string {
    $this->contents[$record['name']] = $record;
    return $record['name'];
  }

  public function addUser($record): string {
    $this->contents[$record['username']] = $record;
  ...
  public function findAllByName(string $name) {
    return array_filter($this->contents, function ($item) use ($name) {
